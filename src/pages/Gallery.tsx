  ...
  return (
    <Layout>
      ...
      <section 
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1533777857889-4be7c70b33f7?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3')",
      ...
      >
        ...
        <div className="relative z-10 text-center">
          <h1 className="font-serif text-4xl md:text-6xl font-bold text-white mb-4">Our Gallery</h1>
          <p className="text-lg text-white/90 max-w-xl mx-auto">
            A visual journey through our cuisine and ambiance
          </p>
        </div>
      </section>
